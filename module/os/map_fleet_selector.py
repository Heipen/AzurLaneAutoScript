...
class StorageFleetSelector(FleetSelector):
    ...
    def bar_opened(self):
        ...
        return self.main.image_color_count(area, color=(200, 207, 231), threshold=30, count=400) \
               and self.main.image_color_count(area, color=(214, 150, 96), threshold=30, count=150)
